...
describe("data-parser", () => {
  ...
  describe("parseCondition", () => {
    it("парсит простое условие", () => {
      ...
      expect(result.metadata?.expression).toBe("${arguments[0]}")
    })
    ...
    it("парсит сложное условие", () => {
      ...
      expect(result.metadata?.expression).toBe("${arguments[0]} && ${arguments[1]}")
    })
  ...
  describe("parseText", () => {
    ...
    it("парсит текст с одной переменной", () => {
      ...
      expect(result.expr).toBe("Hello, ${arguments[0]}!")
    ...
    it("парсит текст с несколькими переменными", () => {
      ...
      expect(result.expr).toBe("${arguments[0]} - ${arguments[1]}")
      expect(result.value).toBeUndefined()
    })
  })
